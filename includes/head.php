...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php
            if (isset($_SESSION['S_ROL']) &&  $_SESSION['S_ROL'] == 1 || isset($_SESSION['S_ROL']) &&  $_SESSION['S_ROL'] == 2 || isset($_SESSION['S_ROL']) &&  $_SESSION['S_ROL']  == 3) {
            ?>
                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseofe" aria-expanded="true" aria-controls="collapseofe">
                        <i class="fas fa-fw fa-building"></i>
                        <span>Ofertas laborales</span>
                    </a>
                    <div id="collapseofe" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                            <?php
                        ...
                        <div class="topbar-divider d-none d-sm-block"></div>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-4 d-none d-lg-inline text-gray-600 ">
                                        <?php
                                        echo "Bienvenido " . $_SESSION['S_NOM'] . "</br> " . $_SESSION['S_APE'];
                                        ?>
                                    </span>
                                    <img class="img-profile rounded-circle" src="<?php echo RUTAGENERAL; ?>/themplates/img/undraw_profile.svg">
                                </a>
                                <!-- Dropdown - User Information -->
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="<?php echo RUTAGENERAL; ?>source/mi_perfil.php">
                                    ...
                                    <a class="dropdown-item" href="<?php echo RUTAGENERAL; ?>source/mis_postulaciones.php">
